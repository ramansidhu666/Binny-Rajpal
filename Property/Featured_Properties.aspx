        ...
        <div class="left_section_in_5">
            ...
            <div class="ftrd_prprty_hdng"> 
                         <h2>Featured Properties</h2>
                          ...
                          <div class="rr">
         <asp:DropDownList ID="ddlPriceSort" runat="server" AutoPostBack = "true" OnSelectedIndexChanged = "OnSelectedIndexChanged" CssClass="dropdownPrice">
     
    <asp:ListItem Text="High to low price" Value="High" />
    <asp:ListItem Text="Low to high price" Value="Low" />
