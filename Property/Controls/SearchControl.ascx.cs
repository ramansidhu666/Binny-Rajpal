...
namespace Property.Controls
{
    public partial class SearchControl : System.Web.UI.UserControl
    {
        ...
        {
            Session["priceSort"] = ddlPriceSort.SelectedItem.Value;
            (Session["FeatureType"]) = null;
            Session["Favourite"] = null;
            if (!Page.IsPostBack)
            {
                this.Page.Title = "Binni Rajpal & Urmeet Rajpal Realtor:Search Property";
                ...
                if (Convert.ToString(Session["QueryString"]) == "Residential" ||(Convert.ToString(Session["SearchType"]) == "Residential"))
                    SearchResidentialProperties(Session["priceSort"] == null ? "" : Session["priceSort"].ToString());
                else if (Convert.ToString(Session["QueryString"]) == "Commercial" || (Convert.ToString(Session["SearchType"]) == "Commercial"))
                    SearchCommercialProperties(Session["priceSort"] == null ? "" : Session["priceSort"].ToString());
                else if (Convert.ToString(Session["QueryString"]) == "Condo" || (Convert.ToString (Session["SearchType"]) == "Condo"))
                    SearchCondoProperties(Session["priceSort"] == null ? "" : Session["priceSort"].ToString());
                else
                {
        ...
        void SearchResidentialProperties(string SortPrice )
        {
            try
            {
                var data = Convert.ToString(Session["QueryString"]);
                    ...
                    {
                            dt = mlsClient.GetResidentialPropertiesWithPriceSort("0", "0", "0", "0", "0", "0", "0",SortPrice);
                    }
                    else if (Convert.ToString(Session["QueryString"]) == "Residential" && Session["Municipality"] != "")
                    {
                        dt = mlsClient.GetResidentialPropertiesWithPriceSort(Session["Municipality"].ToString(), "0", "0", "0", "0", "0", "0",SortPrice);
                    }
                else if ((Convert.ToString(Session["SearchType"]).ToString() == "Residential"))
                   
                    {
                        dt = mlsClient.GetResidentialPropertiesWithPriceSort(Session["SearchText"].ToString(), Session["HomeType"].ToString(), Session["MinPrice"].ToString(), Session["MaxPrice"].ToString(), Session["Beds"].ToString(), Session["Baths"].ToString(), Session["SaleLease"].ToString(),SortPrice);
                    }
        ...
        void SearchCommercialProperties(string SortPrice)
        {
            try
            {
                Property1.MLSDataWebServiceSoapClient mlsClient = new Property1.MLSDataWebServiceSoapClient();
                ...
                {
                    dt = mlsClient.GetAllCommercialPropertiesWithPriceSort("0", "0", "0", "0", "0", "0" ,SortPrice);
                }
                else if (Convert.ToString(Session["QueryString"]) == "Commercial" && Session["Municipality"] != null)
                
                {
                    dt = mlsClient.GetAllCommercialPropertiesWithPriceSort(Session["Municipality"].ToString(), "0", "0", "0", "0", "0", SortPrice);
                }
                else if ((Convert.ToString(Session["SearchType"]).ToString() == "Commercial"))
                {
                    dt = mlsClient.GetAllCommercialPropertiesWithPriceSort(Session["SearchText"].ToString(), Session["HomeType"].ToString(), Session["MinPrice"].ToString(), Session["MaxPrice"].ToString(), Session["Baths"].ToString(), Session["SaleLease"].ToString(), SortPrice);
                }
        ...
        void SearchCondoProperties(string SortPrice)
        {
            try
            {
                Property1.MLSDataWebServiceSoapClient mlsClient = new Property1.MLSDataWebServiceSoapClient();
                ...
                {
                    dt = mlsClient.GetProperties_CondoWithPriceSort("0", "0", "0", "0", "0", "0", "0", SortPrice);
                }
                else if(Convert.ToString(Session["QueryString"]) == "Condo" && Session["Municipality"] != null)
                //else if (Session["Municipality"] != null)
                {
                    dt = mlsClient.GetProperties_CondoWithPriceSort(Session["Municipality"].ToString(), "0", "0", "0", "0", "0", "0", SortPrice);
                }
                else if ((Convert.ToString(Session["SearchType"]).ToString() == "Condo"))
                    dt = mlsClient.GetProperties_CondoWithPriceSort(Session["SearchText"].ToString(), Session["HomeType"].ToString(), Session["MinPrice"].ToString(), Session["MaxPrice"].ToString(), Session["Beds"].ToString(), Session["Baths"].ToString(), Session["SaleLease"].ToString(), SortPrice);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            Session["priceSort"] = ddlPriceSort.SelectedItem.Value;
            if (Convert.ToString(Session["QueryString"]) == "Residential" || (Convert.ToString(Session["SearchType"]) == "Residential"))
                SearchResidentialProperties(Session["priceSort"].ToString());
            else if (Convert.ToString(Session["QueryString"]) == "Commercial" || (Convert.ToString(Session["SearchType"]) == "Commercial"))
                SearchCommercialProperties(Session["priceSort"].ToString());
            else if (Convert.ToString(Session["QueryString"]) == "Condo" || (Convert.ToString(Session["SearchType"]) == "Condo"))
                SearchCondoProperties(Session["priceSort"].ToString());
            else
            {
                SearchResidentialPropertiesListing();
            }
