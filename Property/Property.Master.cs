    ...
    public partial class Property : System.Web.UI.MasterPage
    {
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li><a href=#>Exclusives </a>");//</li>
                StrMenu.Append("<ul >");
                StrMenu.Append("<li><a href='http://www.iciworld.com/result?ft=ntce&memb.memberid_eq=listhomes@yahoo.com' title=''>My Haves and Wants</a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10920&pg=citiesONrespage'>Residential Haves and Wants, Mostly Exclusive</a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10920&pg=citiesONactive'>Ontario Commercial, Mostly Exclusive </a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10920&pg=indexworld'> World Commercial</ a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10920&pg=businessforsaleactive'>Business Haves and Wants </a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10920&pg=citiescanadafsbo'>For Sale by Owner </a></li>");
                StrMenu.Append("</ul>");
