    ...
    public partial class Featured_Properties : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                GetFeatureProperties(Session["priceSort"] == null ? "" : Session["priceSort"].ToString());
            }
        ...
        void GetFeatureProperties(string SortPrice)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@SortPrice", SqlDbType.VarChar).Value = SortPrice;
                cmd.Connection = con;
                if(con.State == ConnectionState.Closed)
                {
                    con.Open();
